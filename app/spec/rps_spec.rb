  ...
  describe 'Round' do
    ...
    describe ".initialize" do
      ...
      it "starts the round without plays or a result" do
        expect(@round1.round_info[:player_1_move]).to be_nil
        expect(@round1.round_info[:player_2_move]).to be_nil
        expect(@round1.round_info[:result]).to be_nil
      end
    end
    ...
    describe "#player_1_move! and .player_2_move!" do
      it "assigns a value to @player_1_move or @player_2_move" do
        ...
        expect(@round1.round_info[:player_1_move]).to eq('r')  
        expect(@round1.round_info[:player_2_move]).to eq('s')
      end
    end
    ...
    describe "#result" do
      ...
      it "returns nil if the round is not complete" do
        ...
        expect(round2.round_info[:player_2_move]).to be_nil
      end
    end
  end
end